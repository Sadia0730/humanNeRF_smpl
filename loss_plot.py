...
log_file_path = '/data/humanNeRF_smpl/experiments_with_nan_backup_without non_rigid/human_nerf/zju_mocap/p387/logs.txt'
output_file_path = '/data/humanNeRF_smpl/experiments_with_nan_backup_without non_rigid/human_nerf/zju_mocap/p387/adventure/loss_track.txt'
